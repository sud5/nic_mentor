        ...
        function ($, JqUi, Ajax, str, Autocomplete, notification, Templates, URL) {
            var manager = {
                ...
                pagination: function (e) {
                    ...
                    if (isNaN(page)) {
                        ...
                        var loader = $('<img />')
                                ...
                                .addClass('spinner');
                        ;
                        $('.school-database-report').html('<div class="text-center">' + loader.get(0).outerHTML + '</div>');
                        promise = Ajax.call([{
                                methodname: 'local_mentor_school_database',
                                args: {
                                    page: page,
                                    name: name
                        ...
                        promise[0].then(function (results) {
                            $('.school-database-report').html(results.html);
                ...
                show_mentors: function () {
                    ...
                    var dwnload = $(this).attr('mentorlink');
                    $('form').attr('action', dwnload);
                    var mid = $(this).attr('schoolid');
                    $('#reportid').val(mid);
