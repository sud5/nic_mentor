...
echo $OUTPUT->header();
echo $OUTPUT->heading('School-Mentor');
$renderer = $PAGE->get_renderer('local_mentor');
echo $renderer->school_list_filter();
echo html_writer::start_div('school-list-report');
echo $renderer->school_display($schools, count($allschools), $page, $perpage, $params);
echo html_writer::end_div();
echo $renderer->custom_modal();
$PAGE->requires->js_call_amd('local_mentor/schools', 'setup');
echo $OUTPUT->footer();
