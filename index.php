...
echo $OUTPUT->header();
echo $OUTPUT->heading("Mentor List:");
...
echo html_writer::start_div('mentor-user-report');
echo $renderer->mentor_report_display($availablementors, count($allavailablementors), $page, $perpage);
